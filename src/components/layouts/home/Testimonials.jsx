          ...
          <div className="">
            ...
            <div className="grid grid-cols-3 gap-6">
              <div className="py-11.25 pl-12.25 pr-16 rounded-[10px] shadow-[0px_0px_20px_2px_rgba(0,0,0,0.05)] relative group">
                <div className="w-[43px] h-[43px] rounded-[50%] bg-[#343434] flex justify-center items-center absolute top-[14%] left-[29%] group-hover:bg-primary duration-300">
              ...
              <div className="py-[45px] pl-[49px] pr-[64px] rounded-[10px] shadow-[0px_0px_20px_2px_rgba(0,0,0,0.05)] relative group">
                <div className="w-[43px] h-[43px] rounded-[50%] bg-[#343434] flex justify-center items-center absolute top-[14%] left-[29%] group-hover:bg-primary duration-300">
                  <RiDoubleQuotesL className="text-white" size={30} />
                </div>
